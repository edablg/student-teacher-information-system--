...
#deneme {
  ...
  <li><a class=' active'href="#ssupervisor.php">My Supervisor</a></li>  
...
$result = mysqli_query($con, " select i.ssn , i.iName from gradstudent g join instructor i where g.supervisorSsn = i.ssn and g.ssn = '$ssn';");
