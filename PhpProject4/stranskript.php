...
#deneme {
  ...
  <li><a class=' active' href="#stranskript.php">The Grade Report</a></li>
...
session_start();
 ...
 $result = mysqli_query($con, "select courseCode,lettergrade from enrollment where sssn = '$ssn'"); 

    echo "<table style='border: solid 1px black;'>";
                echo "<tr><th>Course Code</th><th>Letter Grade</th></tr>";
                if (mysqli_num_rows($result)>0) {
                    while ($obj = mysqli_fetch_assoc($result)) {
                        echo "<tr><td>" . $obj["courseCode"] . "</td><td>" . $obj["lettergrade"] . "</td> </tr> ";
                    }
                }
                ?>
