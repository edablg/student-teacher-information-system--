...
#deneme {
  ...
  <li><a class=' active'href="#scurricula.php">Curricula</a></li>
...
session_start();
 ...
 $result = mysqli_query($con, "select distinct C.courseCode
                    from  student S, curriculacourses C
                    where   S.currCode=C.currCode and ssn= '$ssn'"); 
         ...
         echo "<table style='border: solid 1px black;'>";
                ...
                if (mysqli_num_rows($result)>0) {
                    while ($obj = mysqli_fetch_assoc($result)) {
                        echo "<tr><td>" . $obj["courseCode"] . "</td></tr> ";
                    }
                }
                ?>
</div>
