...
#deneme {
  ...
  <li><a class=' active'href="#iadvising.php">#Students I Advise</a></li>
...
$result = mysqli_query($con, "select distinct s.ssn , s.studentName from student s, instructor i , gradstudent g  where i.ssn = '$issn' and s.advisorssn = i.ssn and  s.gradorUgrad = 0 ;"); 
