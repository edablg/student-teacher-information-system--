...
#deneme {
  ...
  <li><a class=' active'href="#iprojects.php">Projects I Manage</a></li>
...
<div id="deneme">
 ...
 $issn = $_SESSION['currentid'] ;
  $result = mysqli_query($con, "select i.iName, p.pName, p.subject from instructor i join project p on i.ssn = p.leadSsn where i.ssn = '$issn'"); 

   
        
        echo "<table style='border: solid 1px black;'>";
                echo "<tr><th>iName</th><th>pName</th><th>Subject</th></tr>";
                if (mysqli_num_rows($result)>0) {
                    while ($obj = mysqli_fetch_assoc($result)) {
                        echo "<tr><td>" . $obj["iName"] . "</td><td>" . $obj["pName"] . "</td><td>" . $obj["subject"] . "</td></tr> ";
                    }
                }
                ?>
</div>
