...
#deneme {
  ...
  <li><a class=' active'href="#scourses.php">My Courses</a></li>
...
include './dbconnect.php';
 session_start();
 $sssn = $_SESSION['currentid'] ;
$result = mysqli_query($con, "select distinct c.courseName from enrollment e join course c on e.courseCode = c.courseCode where sssn = '$sssn';");
